...
INSERT INTO `__new_transaction_request`("id", "person_id", "request_type", "status_code", "requested_at", "correlation_id", "payload_version", "payload_json") SELECT "id", "person_id", "request_type", "status_code", "requested_at", "correlation_id", "payload_version", "payload_json" FROM `transaction_request`;--> statement-breakpoint
