...
test("MVP-A policy-as-code input loader scans P2X bounded practical-use artifacts", async () => {
  ...
  const p2xFixtureClaims = [
    ...
    [
      "docs/p2x-04-raw-payload-csv-export-prerequisite-lane.md",
      [
        "Unrestricted raw payload is ready.",
        ...
        "Export permission runtime is ready.",
        ...
        "Template allowlist is complete.",
        "Watermark or manifest is ready.",
        "Watermark/manifest is ready.",
        "Download-log evidence is complete.",
        "Download log evidence is complete.",
        "Prohibited-payload controls are approved.",
        "Negative broad-export tests are complete.",
    ...
    [
      ...
      [
        ...
        "HR practical-use readiness: Go.",
        "Production-like readiness: Go.",
        "| No-orphan tests | Completed |",
        "| Future-extension runtime | Completed |",
