...
characters, and the actor object supplies `actorId`, `actorRole`, `tenantId`,
`permissions`, and bounded `dataScope`. The same server-owned manifest, actor registry, and
