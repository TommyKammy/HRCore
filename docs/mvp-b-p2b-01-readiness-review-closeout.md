...
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| #249 transfer transaction_request schema / validation      | `src/transfer-transaction-request.ts`; `src/transfer-transaction-request-contract.ts`; `src/transfer-transaction-request-contract.test.ts`; `drizzle/0014_transfer_transaction_request.sql` | Bounded synthetic transfer payloads can be created and validated. Unsupported later-wave, regulated, raw/export, real-data, and live-provider fields fail closed.                                                                                      |
