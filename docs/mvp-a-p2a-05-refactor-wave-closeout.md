...
| ------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| onboarding transaction helper split               | #226, PR #233      | `src/onboarding-transaction-request-internal.ts`, `src/onboarding-transaction-request-parser.ts`, `src/onboarding-transaction-request-validation.ts`, `src/onboarding-transaction-request-ids.ts`, `src/onboarding-transaction-request-error.ts`, `src/onboarding-transaction-request-readers.ts`, `src/onboarding-transaction-request-types.ts`, `src/onboarding-transaction-request.test.ts`                | Parser, validation, id, error, row-reader, and type ownership moved out of the former internal bundle. The internal compatibility surface remains import-compatible, and parser/validation/lifecycle tests remain in place.                                                |
