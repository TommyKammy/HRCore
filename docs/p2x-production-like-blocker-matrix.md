...
| production authorization/RLS   | P0-R05 / #11; ADR 0011; `docs/mvp-a-onboarding-evidence-authorization-gate.md`; `docs/solo-maintainer-governance.md`; `docs/p0-gov-01-solo-maintainer-governance-closeout.md` | Blocked; bounded app checks are not production RBAC/RLS authority     | Accepted authorization/data-scope design, actor/role/tenant binding, trusted proxy identity boundary, PostgreSQL RLS source-of-truth decision, negative enforcement tests, and mixed-boundary fail-closed evidence.  | two-key decision; architecture decision                             |
