...
| `docs/adr/0006-personal-data-processing-purpose-and-consent-record.md` | Proposed personal-data processing purpose and consent boundary     | Proposed/design anchor only; not accepted approval for this lane.                                                               |
...
| `docs/adr/0016-my-number-extension-anchor.md`                          | Proposed future extension anchor for regulated identifier handling | Proposed/design anchor only; no My Number or regulated identifier runtime is introduced.                                        |
