...
| practical-use-ready    | No-go until unblocked | HR operators must not use this for practical HR work until the follow-up issues below close with accepted evidence.       |
| production-like-ready  | No-go until unblocked | Production-like runtime, real tenant, real-data, audit immutability, backup, export, and ops gates are not accepted.      |
...
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P2A-01 implementation evidence                | P2A-01 onboarding request, approval, apply, future-date apply, mock Okta projection, and work_email writeback implementation through issues #175-#182. | Sufficient for bounded MVP-A E2E review when paired with P2A-02 traceability. It is not a practical-use or production-like claim.                                                                                                                                |
